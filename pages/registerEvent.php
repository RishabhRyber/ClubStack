...
<head>
    ...
    ?>
    <title>Register Your Event</title>
    <style>
        .navbar {
        margin-bottom: 0%;
 ...
 <body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
      ...
      if (isset($_POST['submit'])) {
          $errors=eventRegister();
          if(count($errors)==0){
              echo "<div class='alert alert-success'>
              <button type='button' class='close' data-dismiss='alert'>&times;</button>
              <strong>Congrats!</strong> You have succesfully Registered Your Event.</div>";
    ...
    <table>  
        ...
        <tr>
            ...
            <td>
            <input type="text" name="eventTagline">
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
            <input type="number" name="regisFee">
            </td>
        </tr>
        <tr>
            <?php
